...
search_term = input("Enter Organism: ")

#Advises user to put full scientific name of an organism if they only put 1 name.

if len(search_term.split()) < 2:
    print("Consider putting full scientific name.")
...
if int(record['Count']) > 500:
    print("Due to the large amount of results, only the first 500 results will be returned.")
